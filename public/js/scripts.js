...
$('.oks-user-log-info ul li:first-child a').on('click', function (e) {
    e.preventDefault();
...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > headerHeight) {
            ...
            $('.site-header').addClass('oks-dasboard-sticky');
        } else {
            header.removeClass('sticky');
            $('.site-header').removeClass('oks-dasboard-sticky');
        }
    });
});
$('.eks-login-popup').hide();
$('.oks-user-info .ekas-login').on('click', function (e) {
    e.preventDefault();
    $('.eks-login-popup').show();
});
$('.eks-login-popup i').on('click', function () {
    $('.eks-login-popup').hide();
});
