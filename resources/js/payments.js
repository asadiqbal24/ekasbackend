...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      serverSide: true,
      ajax: {
        url: baseUrl + 'stripe/payments/list'
      },
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
            ...
            render: function (data, type, full, meta) {
                ...
                return '<span class="datetime">' + $amount + '</span>';
        ...
        className: 'text-center',
        render: function (data, type, full, meta) {
            return '<span class="datetime">EUR</span>';
        ...
        render: function (data, type, full, meta) {
            ...
            return '<span class="datetime">' + $status + '</span>';
        ...
        className: 'text-center',
        render: function (data, type, full, meta) {
            var $phone_no = full['phone_no'];
            return '<span class="datetime">' + $phone_no + '</span>';
...

        {
            ...
            render: function (data, type, full, meta) {
                ...
                return '<span class="datetime">' + $service_type + '</span>';
          ...
          
          {
            ...
            className: 'text-center',
            render: function (data, type, full, meta) {
              var $package = full['package'];
              return '<span class="datetime">' + $package + '</span>';
